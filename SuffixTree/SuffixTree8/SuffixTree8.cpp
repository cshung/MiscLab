...
SuffixTree8::SuffixTree8Edge::SuffixTree8Edge() : m_suffixLink(nullptr), m_stringDepth(0)
{
...
bool SuffixTree8::Add(int keyBegin, int keyEnd, SuffixTree8Builder* builder)
{
    ...
    if (treeEdgeCursor == treeCursor->length())
    {
        ...
        if (treeCursor == this->m_root)
        {
            ...
            this->m_root->m_children.insert(pair<char, SuffixTree8::SuffixTree8Edge*>(builder->m_input[keyBegin], newEdge));
