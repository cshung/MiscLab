...
def minimum_mean_cycle(number_of_nodes, edges):
    ...
    states = minimum_mean_cycle_states(number_of_nodes)
...
def minimum_mean_cycle_helper(node, adjacency_list, states):
    ...
    if states.start_time[node] == states.low[node]:
        ...
        minimum_mean_cycle_within_connected_component(connected_component_nodes, connected_component_edges, states)

def minimum_mean_cycle_within_connected_component(connected_component_nodes, connected_component_edges, states):
    ...
    for step in range(1, number_of_nodes + 1):
        for edge in connected_component_edges:
